...
//Makes a 256x256 black square with a white center.
void MakeSquare256() {
	BMPCanvas canvas = BMPCanvas("square256", 256, 256);
	for(int x = 0; x < canvas.getWidth(); x++) {
		for(int y = 0; y < canvas.getHeight(); y ++) {
			if(x >= 64 && x < 192 && y >= 64 && y < 192){
				canvas.setPixel(x, y, Color(255, 255, 255));
			} else {
...
void MakeSphere256() {
	BMPCanvas canvas = BMPCanvas("sphere256", 256, 256);
	for(int x = 0; x < canvas.getWidth(); x++) {
		for(int y = 0; y < canvas.getHeight(); y ++) {
